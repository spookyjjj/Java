public class IntegerToString {
	public static void main(String args[]) {
		...
		System.out.println(strNum2 + a + 100); //1234512345100 ->앞에서부터 계산하니깐 결합하고 결합
		System.out.println(100 + a + strNum2); //1244512345 ->앞에서 부터 계산하니깐 연산하고 결합
		System.out.println(strNum2 + (a + 100)); //1234512445 ->연산부터 하고 싶음 괄호
