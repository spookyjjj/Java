...
//		Boolean
		...
		Integer i = new Integer(10); //하지만 Wrapper class를 통해 객체로 만들어 줄 수도 있다 -> new 어쩌구 이건 곧 업뎃으로 사라질 표현
//		System.out.println(i);
		Integer i2 = Integer.valueOf(500); //boxing(valueOf메소드) -> 뉴 어쩌구 하는거 이 메소드로 대체 해서 써야함~
		int primitiveInt = i2.intValue(); //unboxing(intValue메소드)
		...
		int result = Integer.valueOf("1234"); //인티저가 인트로 변환되는 과정이 일어난 결과! -> 자동 언박싱
		
		Integer.parseInt("4567"); //parseInt는 아예 String -> Int형으로 반환하는 메소드
	}
